...
module.exports = {
  ...
  onStart: async function ({ message, args, api, event }) {
    ...
    try {
      ...
      const apiUrl = `https://xl31-8jwj.onrender.com/kshitiz?prompt=${encodeURIComponent(prompt)}&ratio=${encodeURIComponent(finalRatio)}&style=${encodeURIComponent(finalStyle)}`;
